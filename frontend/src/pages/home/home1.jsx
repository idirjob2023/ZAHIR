...
<div style="font-size:11px; color:#000; width: 230px;">
	  <input type="checkbox" 
      value="1" 
      name="restitution_diff" 
      id="restitution_diff" 
      class="restitution-diff">
							<label for="restitution_diff" style="margin-top: -19px;    float: left;    margin-left: 19px;">Agence de restitution différente</label> 
</div>

style={{margintop:-19,  float: 'left',   marginleft: '19px'}} 